...
export class Lexer {
    ...
    private readString(): Token {
        ...
        if (quote === '`') {
            ...
            throw new Error(`Unexpected quote type at line ${startLine}, column ${startColumn}`);
        }
    ...
    // Function to handle single-line strings (enclosed in double quotes)
    ...
    // Function to handle multi-line strings (enclosed in backticks)
    ...
    private readOperator(): Token {
        ...
        throw new Error(`
            ${currentLineStr}
            Invalid operator at line ${this.line}, column ${this.column}
        `);
    }
